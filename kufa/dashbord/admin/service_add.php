                ...
                <form action="./service_data.php" method="post">
                    <div class="example-container">
                        <div class="example-content">
                            ...
                            <input type="text" class="form-control form-control-rounded m-b-sm" name="service_title">
                        </div>


                        <div class="example-content">
                            <label for="">service icon</label>
                            <input readonly type="text" class="form-control form-control-rounded m-b-sm" name="service_icon" id="icon_value">
                        </div>
                        ...
                        <div class="example-content">
                            ...
                            <textarea name="service_description" id="" cols="30" rows="5" class="form-control form-control-rounded m-b-sm" class="service_description"></textarea>
                        </div>
