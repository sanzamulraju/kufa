<?php
$tab_title='portfolio_single.php';
                        ...
                        <div class="single-blog-list">
                            ...
                            ?>
                                <div class="blog-list-thumb mb-35">
                                    <img src="../dashbord/uploads/works/<?= $work['work_img'] ?>" alt="img">
                                </div>
                                <div class="blog-list-content blog-details-content portfolio-details-content">
                                    <h2><?= $work['work_heading'] ?></h2>
                                ...
                                <div class="avatar-post mt-70 mb-60">
                                    <ul>
                                        <li>
                                            <?php
                                            $id = $_SESSION['auth_id'];
                                            $user_profile_qurey = "SELECT * FROM aouths WHERE id = $id";
                                            $user_profile_qurey_db = mysqli_query($db_connect, $user_profile_qurey);
                                            $profile = mysqli_fetch_assoc($user_profile_qurey_db);
                                            ?>
                                            <div class="post-avatar-img">
                                                <img src="../dashbord/uploads/profile/<?= $profile['profile_pic'] ?>" alt="img">
                                            </div>
                                            <div class="post-avatar-content">
                                                ...
                                                <div class="post-avatar-social mt-15">
                                                    ...
                                                    <a href="<?= $links['twitter'] ?>"><i class="fab fa-twitter"></i></a>
